...
GOTO doshift
:noshift
D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\php\.\php.exe -q -d output_buffering=1 -d include_path="\xampp\php\pear" \xampp\php/Text/Highlighter/generate.bat %MHL_PARAMS%

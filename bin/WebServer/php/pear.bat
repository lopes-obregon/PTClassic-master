...
FOR %%x IN ("D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\php\.\php.exe"

...
SET phpCli=D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\php\.\php.exe
...
"%phpCli%" -d html_errors=off -qC "D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\php\pear\phing.php" %*
GOTO :EOF

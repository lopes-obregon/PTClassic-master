...
#!perl
#line 29
    eval 'exec D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'D:\MyProjects\GameDev\Pristontale\PublicSource\bin\WebServer\perl\bin\perl.exe';

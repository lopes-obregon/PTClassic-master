...
if ( -d 'D:\\xampp\\minicpan' ) {
  ...
  unless ( $@ ) {
    if ( LWP::Online::online() ) {
      push @urllist, q[file:///D:/MyProjects/GameDev/Pristontale/PublicSource/bin/WebServer/xampp/minicpan/];
    } else {
      unshift @urllist, q[file:///D:/MyProjects/GameDev/Pristontale/PublicSource/bin/WebServer/minicpan/];
    }
  }
}

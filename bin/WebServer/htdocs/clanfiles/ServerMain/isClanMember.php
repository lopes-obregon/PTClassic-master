...
$ClanNote = $results['Note']; 
$ClanImg = $results['MIconCnt']; 
$CreateDate = $results['RegiDate']->format('n/j/Y');
$EndDate = $results['LimitDate']->format('n/j/Y'); 
$PFlag = $results['PFlag']; 
$KFlag = $results['KFlag'];
$ClanMoney = $results['ClanMoney']; 
$iIMG = $ClanImg;
$CNFlag = ""; 
$Pontos = ""; 
$tclName = "";

...
#ifdef USE_NEW_SQLFUNCTIONS
				sqlClanDb.ClanUserTicKets(sClanEvent->szID, sClanEvent->szName, sClanEvent->szIP, sClanEvent->TicketNum, sClanEvent->Param[0], sClanEvent->Param[1], sClanEvent->Param[2]);
				break;
		
				sqlClanDb.ClanUserTicket(sClanEvent->szID, sClanEvent->szName, sClanEvent->szIP, sClanEvent->TicketNum, sClanEvent->Param[0]);
				break;
#else
